...
class PredictPipeline:
    ...
    def predict(self, features):
        try:
            ...
            corr_columns = ['c21', 'c142', 'c176', 'c102', 'c41', 'c113', 'c158', 'c223', 'c56', 'c134', 'c110',
                            'c81', 'c58', 'c12', 'c124', 'c215', 'c138', 'c149', 'c23', 'c104', 'c25', 'c43', 'c131',
                            'c205', 'c94', 'c132', 'c182', 'c133', 'c229', 'c128', 'c126', 'c47', 'c130', 'c218',
                            'c155', 'c189', 'c97', 'c146', 'c112', 'c199', 'c174', 'c125', 'c185', 'c127', 'c211', 'c95']

            data_scaled_df_cfs = data_scaled_df.drop (corr_columns, axis =1)
            
            data_scaled_df_cfs_np = np.array(data_scaled_df_cfs)
            preds = model.predict(data_scaled_df_cfs_np)
            return preds
